<nav id="main-nav">
    ...
    <ul class="bottom-nav">
        <li class="ree-hc">
            <a href="tel:{{$info->telephone_1}}" rel="noreferrer" target="_blank">
        ...
        <li class="ree-hc">
            <a href="mailto:{{$info->email_1}}" target="_blank">
        ...
        <li class="ree-hc">
            <a href="wa.me/{{ str()->of($info->telephone_2)->replaceMatches('/[^A-Za-z0-9]++/', '')}}" rel="noreferrer" target="_blank">
